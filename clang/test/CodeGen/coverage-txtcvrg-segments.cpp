...
// on line 11 which proves that the call returned. The preceding rendering gap
// ends at 11.3, but the continuation CodeRegion starts at 11.7; executable
// output must use the latter rather than manufacturing a whitespace start.
// CHECK:      function	"_Z8compoundb"	7	0	0.00
// CHECK-NEXT: 1	8.25	10.13	0
// CHECK-NEXT: 1	10.13	10.24	0
// CHECK-NEXT: 1	11.7	11.14	0
